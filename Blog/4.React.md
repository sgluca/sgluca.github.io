...
{
    "expo": {
        "name": "Applicazione", // Nome dell'applicazione
        "slug": "App",
        ...
        "ios": {
            ...
            "bundleIdentifier": "it.sgluca.app", // Identificatore del bundle per iOS
        ...
        "android": {
            ...
            "package": "it.sgluca.app", // Identificatore del pacchetto per Android
...
_sostituire `<username>` con il proprio nome utente_
